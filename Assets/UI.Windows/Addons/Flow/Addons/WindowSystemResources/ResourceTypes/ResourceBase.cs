...
namespace UnityEngine.UI.Windows {
	...
	public class ResourceBase {
		...
		public ResourceBase(ControlType controlType, bool async) {
		...
		public virtual void Validate(Object item) {
			...
			*/
			...
			var fileExt = System.IO.Path.GetExtension(this.assetPath).Trim('.').ToLower();
			ME.EditorUtilities.SetValueIfDirty(ref this.isMovie, (fileExt == "avi" || fileExt == "mp4" || fileExt == "ogv" || fileExt == "mov"));
